...
%
%Graphical
% ARROW - draw an arrow in the current axes with optional text at the beginning
% ARROWM - draw an arrow in the current axes with optional text in the middle aligned with arrow
% ARROWTWO - draw two-headed arrow with optional text
...
% WAITSPINNER - put a spinning icon in your figure to indicate busy
...
% ISEBCDIC - guess if text is ebcdic 
%
