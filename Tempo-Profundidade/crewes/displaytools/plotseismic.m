function plotseismic(seis,t,x,kol,pscale)
% PLOTSEISMIC: A wtva seismic viewer with GUI controls
%
% plotseismic(seis,t,x,kol,pscale)
%
...
%      ********** default = 'b' (blue) **********
% pscale ... initial value of plot amplitude scalar. Make larger for larger trace excursions
%      ********** default =2 *************
% 
...
if(nargin>5)
   error('plotseismic can have no more than five input arguments');
end
...
%     grey=[.7529 .7529 .7529];
    ...
    uimenu(hcntx,'label','Publish Zoom Limits','callback','plotseismic(''pubzoom'')','separator','on',...
        'enable','on');
    uimenu(hcntx,'label','Match Zoom','callback','plotseismic(''matchzoom'')','enable','on');
