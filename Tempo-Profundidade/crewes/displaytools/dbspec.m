...
%                       ************* default=0 **************
% NOTE: window flags may be a single scalar if all traces are to be windowed the same.
...
% traces.
% ha= handle of average spectrum if requested
% 
% 
