function clearpicksbutton(figno)
%
...
% wpixels=130;%desired width in pixels
% %determine window size
% pos=get(figno,'position');%should be in pixels
% %
% width=wpixels/pos(3);%width in normaliized units
width=.1;
uicontrol(figno,'style','pushbutton','string','clear picks','units','normalized',...
    'position',[startpos .95 width .05],'callback','clearpicks;clearlines','tag','clearpicksbutton');