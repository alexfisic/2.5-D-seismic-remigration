...
if nargin == 2
    trcrange = checkTrcRange(trcrange,obj.TracesInFile);    
    whattoread = 'both';
    gui = 1;
end
...
trcrange=obj.TraceOneOffset+(trcrange-1)*obj.TraceSize;
...
function trcrange = checkTrcRange(trcrange,maxtrace)
