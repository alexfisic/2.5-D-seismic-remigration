function [dump,words,inotempty]=traceheaderdump(trchdr,iwrite)
% TRACEHEADERDUMP: does a complete dump of the SEGY trace headers from a SegyFile object
%
% [dump,words,inotempty]=traceheaderdump(trchdr,iwrite);
%      or
...
% iwrite ... 1 means write to the command window the names of non-empty header words. 0 means don't
%           write.
% ************* default =1 ************
