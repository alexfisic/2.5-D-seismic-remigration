...
%         disp('SegyFile: calling superclass constructor');
        ...
        obj.SampleInterval = obj.BinaryHeader.SampleInterval;
        obj.SamplesPerTrace = obj.BinaryHeader.SamplesPerTrace;
        ...
        obj.Trace = SegyTrace(obj.FileID,obj.Permission,obj.SegyRevision,...
            sampint,nsamp,fmtcode,obj.ByteOrder,obj.GUI);
