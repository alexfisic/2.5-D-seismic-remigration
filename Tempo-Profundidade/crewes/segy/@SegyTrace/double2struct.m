...
%Converts an array of doubles to a trace header struct
%
% function s = double2struct(d,f,t)
% Where:
...
function data = convertdatatype(data,datatype)
    ...
    switch datatype
        ...
        otherwise
            mm_errordlg('@Trace/double2struct: Unknown data type','Error!',obj.GUI);
    end
    if ~allswell
        mm_errordlg(['@Trace/double2struct: Data contains NaN or Inf or is out of range for storage '
               'as ' datatype],'Error!',obj.GUI);
    end
end
