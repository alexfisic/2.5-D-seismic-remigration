...
%Create and populate a new textual file header based on the SEG-Y revision number
%
%function thead = new(obj,segyrev)
%
...
switch(floor(segyrev))
    ...
    otherwise
        mm_errordlg(['@TextHeader/new: Unknown SEG-Y revision number: ' num2str(segyrev)],...
            'Error!',obj.GUI);
end
