...
if segyrev == 0
    bd = [bd; mkunassigned(1,85,60)];
elseif segyrev == 1
    bd = [bd; mkunassigned(1,60,60)];
    bd(88,:)={'SegyRevNum','uint16',300,'*SEGY Format Revision Number'};
    bd(89,:)={'FixedLenTraces','int16',302,'*Fixed length trace flag'};
    bd(90,:)={'NumExtTextHdrs','int16',304,'*Number Extended Textual File Headers'};
    bd(91,:)={'Unassigned61','uint16',306,'Unassigned 61'};
