function sf=hyperfilt(s,t,t0,fmin,fmax,fmaxmax,phase,max_atten,option,twin)
% hyperfilt ... time variant bandpass filter whose passband follows hyperbolic trajectories
%
% sf=hyperfilt(s,t,t0,fmin,fmax,fmaxmax,phase,max_atten,option,twin)
%
