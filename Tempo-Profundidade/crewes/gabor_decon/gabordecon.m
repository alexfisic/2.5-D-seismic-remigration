function [trout,tvs_op]=gabordecon(trin,t,twin,tinc,tsmo,fsmo,ihyp,stab,phase,p,gdb,ipow,transforms,taperpct)
% GABORDECON: nonstationary seismic deconvolution using the Gabor transform
%
% [trout,tvs_op]=gabordecon(trin,t,twin,tinc,tsmo,fsmo,ihyp,stab,phase,p,gdb,ipow)
%
...
if(nargin<12); ipow=1; end
if(nargin<13); transforms=3; end
if(nargin<14); taperpct=50; end
normflag=0;
