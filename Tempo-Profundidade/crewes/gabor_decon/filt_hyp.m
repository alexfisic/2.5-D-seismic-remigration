function sf=filt_hyp(s,t,t1,fmin,fmax,fmaxlim,phase,max_atten,option,twin,ievery,iwait)
% FILT_HYP ... time variant bandpass filter whose passband follows hyperbolic trajectories
%
% sf=filt_hyp(s,t,t1,fmin,fmax,fmaxlim,phase,max_atten,option,twin,ievery,iwait)
%
