function [q,r]=desigpoly(b,a)
% q= desigpoly(b,a)
% [q,r]= desigpoly(b,a)
%
% This is a modification of MATLAB's DECONV function to behave as
% a typical seismic designature algorithm. 'b' contains a seismic
% trace while 'a' contains a signature to be removed from 'b' 
% using MATLAB's DECONV algorithm. The length of the resultant, 'q',
% is equal to the length of 'b'.
% 
...
%
% modified to DESIG by G.F. Margrave, May 1991
