function sout=nmor(s,t,x,v,dir,params)
% NMOR: forward or reverse normal moveout removal
%
% sout=nmor(s,t,x,v,dir,params)
%
...
% **************** default = 0 **************************
% NOTE: you can give a values of nan for a param and that will trigger the
% default
%
