...
% ******** default n=length(t) ***********
% flag ... if 0, the f vector is returned unwrapped (f=0 in center, values between -Nyq and Nyq)
%          if 1, the f vector is returned wrapped (f=0 is first sample, , values between -Nyq and Nyq)
%          if 2, the f vector is returned wrapped (f=0 is first sample, , values between 0 and 2*Nyq)
%   ******* default 0 *******
