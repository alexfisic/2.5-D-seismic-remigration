...
% consists of a cell array of the handle of the new line, a vector of x coordinates and a
% vector of y coordinates. 
%
% lineinfo={key handle x y}
%
% The key gives needed information about the new line as follows:
% key = 1 ... the line was created by drawing with the mouse
...
% linestyle, etc. This is appended to the above information using a NaN as
% a flag. Thus if key==4, then :
...
% clean up graphics if needed
    ...
    hundo=findobj(gcf,'tag','yrag_trans');
% 	h=get(gcf,'children');
% 	found=0;
% 	for k=1:length(h)
