function ca = getSectionAssociation(obj, sn)
%function ca = getSectionAssociation( obj, sn )
% Returns associated section name(s) selected from obj.sections based on indices
...
% etc.
%
% If no matches to sn are found in the object, getSectionName returns ''
%
%
