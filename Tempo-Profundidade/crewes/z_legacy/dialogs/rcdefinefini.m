function [sonicnum,densitynum,densityopt,holealg,domain,a,m,name]=rcdefinefini
% [sonicnum,densitynum,densityopt,holealg,domain,a,m,name]=rcdefinefini
%
% Call this to complete the rc definition dialog. Return values mean:
