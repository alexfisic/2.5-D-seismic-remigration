function [t,p]=traceray_pp(vp,zp,zs,zr,zd,x,xcap,pfan,itermax,optflag,pflag,dflag)
%
% [t,p]=traceray_pp(vp,zp,zs,zr,zd,x,xcap,pfan,itermax,optflag,pflag,dflag)
%
...
%
	...
	%end the while loop
	if(~captured & pflag)
		disp([' capture failed for z1,z2= ' num2str(z1) ',' num2str(z2) ...
		' and x= ' num2str(x(k))]);
	end
