...
%     significant spectral features?). This should be a positive integer
%     and is actually the length of a frequency domain prediction filter.
%     (See Claerbout 1976 for a discussion.) Values between 4 and 20 work
%     well. The larger the value the more detail will be present in the
%     spectrum. Thus small lc are a very natural and unbiased way to obtain
%     a smooth spectral estimate.
