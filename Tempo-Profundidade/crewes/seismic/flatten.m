...
% NOTE: te and xe must be scalars
% twid ... determines the width of the correlation time window. It goes
%        from the event time + or minus 2*twid. So twid is the 1/4 width.
%        It is in seconds.
%
