...
uiwait(d);
    ...
    function choose_color(~,~)
        ...
        hnew=findobj(hfig,'tag','newcolor');
        hold=findobj(hfig,'tag','oldcolor');
        colors_inuse=hold.UserData;
        thishor=get(hlist,'value');
        oldcolor=newcolors{thishor};
        c=colorchooser(hfig,oldcolor,colors_inuse,transfer);
