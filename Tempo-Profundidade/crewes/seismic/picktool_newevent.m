...
% PLOTIMAGE (or PICKTOOL) automatically retrieves this information and stores it in the pickstruc.
% However, if you are using picktool_newevent by itself on an imagesc display, you will want to
% retireve it after each event has been picked because the
    ...
    case {'newpt','newptalt'}
        ...
        if(strcmp(button,'normal'))
            if(parmstruc.trajfini)
                ...
                %with MB3 and then MB1 was clicked again. This is taken as
