...
SCALE_OPT=2;
dz=100;%depth step
imaginaryfraction=.0001;%including a small imaginary component in the velocity causes slight viscous damping which is a good thing
...
plotimage(seis,t,x)
title('Input')
%% Extrapolate a dipping reflector 
% a dipping reflector
dz=200; %depth step
vel=2000;%velocity
dip=20;%reflector dip
dt=.002;
dx=5;
nt=512;
nx=512;
