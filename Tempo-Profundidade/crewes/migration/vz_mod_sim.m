...
%
% Script generates a depth model with regularly spaced scatterpoints. This is then fed into vz_fkmod
% to compute the diffraction response. The result is then fed into vz_fkmig to collaps the
% diffractions to show resolution size.
%
