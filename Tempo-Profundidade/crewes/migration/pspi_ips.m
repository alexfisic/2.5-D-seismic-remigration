function phiout=pspi_ips(phiin,f,dx,parms,pspi_parms,dz)
%phiout=pspi_ips(phiin,f,dx,parms,pspi_parms,dz)
%
%Isotropic pspi extrapolation.
%
...
for j=1:rv
	...
	temp1=fft(ips(phiin,f,dx,vref(j),dz),[],2);
	temp(:,inds)=temp(:,inds)+temp1(:,inds);
end
