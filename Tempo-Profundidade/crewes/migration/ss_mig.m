function mdata=ss_mig(fdata,f,parms,dx,dz)
%mdata=ss_mig(fdata,f,parms,dx,dz);
%
%***prestack splitestep depth migration***
%
%To see an example, type 'ss_salt_psdm_script' in matlab.
%
...
rtemp=zeros(rd,cd);
for j=1:Nz-1
	disp([' ss prestack mig working on depth ',num2str(j),' of ',num2str(Nz)])
