...
load Pro_salt_vel_pspi
[rm cm]=size(model);
s_model=model/2;
s_pspi_model=pspi_model/2;
load shot_impulse
dt=t(2);
dx=xrec(2);
dz=4;
...
%***migrate***
disp('Your output file will be "pspi_salt_3c_mig"')
pause(3)
pspi_3c_psdm=pspi_3c_mig(fseis,f,model,pspi_model,s_model,s_pspi_model,dx,dz);
%*************

%***output***
save pspi_salt_3c_mig pspi_3c_psdm
%************