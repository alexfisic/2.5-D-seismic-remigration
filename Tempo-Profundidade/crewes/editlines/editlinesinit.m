...
% editlinesinit({hline1 1 x1(10) y1(10) hline2 2 x2(5) y2(5) x2(15) ...
%               y2(15) hline3 -eps})
%	... Similar to the previous case except that line 3 is flagged as having no anchors but
%	being available for immediate editing.
% For more information on the structure of the anchors array, examine the private function
% el_init and the comments beginning on line 41.
%
