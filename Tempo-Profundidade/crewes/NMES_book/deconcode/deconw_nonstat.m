...
sd=deconw(sq,sq,n,stab,wndw);%noiseless deconw
...
[xb,strb]=maxcorr_phs(rb,sdb,ncc);%compute cc and phase after filter
sdn=deconw(sqn,sqn,n,stabn,wndw);%noisey deconw
...
[xbn,strnb]=maxcorr_phs(rbn,sdnb,ncc);%compute cc and phase after filter