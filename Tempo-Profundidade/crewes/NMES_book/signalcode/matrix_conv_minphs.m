...
hdiag=line([1 N],[1 N],[-1 -1],'color',c2,'linewidth',1,'linestyle',':');
...
ht4=text(-2,300,'c)','fontsize',fs,'backgroundcolor','w','verticalalignment','bottom');
ylabel('samples')
...
print -depsc wavepropgraphics\matmultmin
