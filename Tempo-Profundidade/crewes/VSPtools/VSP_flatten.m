function vspflat=VSP_flatten(vsp,t,tp,dir,tshift)
...
% tshift ... constant shift to subtract from tp. This is useful if the event being
% flattened extends to near t=0. Once flattened, such an event may be too
% close to t=0 for comfort. 
% **********  default = 0 *********
%
...
vspflat=stat(vsp,t,-dir*(dtau-tshift));