function [err,cc,phserr]=waveleterr(w,tw,w1,tw1)
%
% [err,cc,phserr]=waveleterr(w,tw,w1,tw1)
% 
% err= L2 norm of difference
% cc = length two vector with maxcorr and lag
% phserr = phase(w)-phase(w1)
%
tbeg=tw(1);
tend=tw(end);
tbeg1=tw1(1);
