...
linf=ixtrace_co-round(nl/1); % Para o modelo Campos, 10
lup=ixtrace_co+round(nl/1);  % Para o modelo Campos, 10
...
else;saida(it,ixtrace_co)=1e-01;end; % FIM DO LAÇO DO TEMPO
