...
data (1:nt,ix) = amp(1:nt)/nt; % ESPECTRO DE AMPLITUDE

data2(1:nt,ix) = d(1:nt)/nt;   % ESPECTRO DE POTÊNCIA
...
figure, plot([1:round(nt/8)]*df,spec_mean(1:round(nt/8),1),[f_central-banda_dado f_central-banda_dado],[0 0.01],'g',[f_central+banda_dado f_central+banda_dado],[0 0.01],'g',[f_central f_central],[0 0.01],'r',[f_dominante f_dominante],[0 0.01],'k'); grid;

figure, plot([1:round(nt/8)]*df,spec_mean(1:round(nt/8),1),[1:round(nt/8)]*df,amp(1:round(nt/8),:)/nt); grid;
